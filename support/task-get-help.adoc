...
summary: 'A NetApp oferece suporte ao Console de diversas maneiras. Diversas opções gratuitas de autoatendimento estão disponíveis 24 horas por dia, 7 dias por semana, como artigos da base de conhecimento (KB) e um fórum da comunidade. Seu cadastro de suporte inclui suporte técnico remoto via sistema de tickets online.' 
---
= Obtenha ajuda com o NetApp Disaster Recovery
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
