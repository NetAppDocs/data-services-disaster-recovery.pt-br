...
[role="lead"]
Saiba o que há de novo no NetApp Disaster Recovery.
...
Para mais detalhes, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/drplan-create.html["Crie um plano de replicação"] .
...
Para obter detalhes sobre como incluir mapeamento de sub-rede em seus sites, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/sites-add.html["Adicionar sites do servidor vCenter"] .
...
Para obter detalhes sobre proteção contra saltos, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/failover.html["Falha na execução de aplicativos para um site remoto"] .
...
Para obter detalhes sobre o uso de soluções de instantâneo externo no plano de replicação, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/drplan-create.html["Crie um plano de replicação"] .
...
Para mais detalhes, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/sites-add.html["Adicionar sites do servidor vCenter"] .
...
Consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/reports.html["Criar relatórios de recuperação de desastres"] .
...
Consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-licensing.html["Configurar licenciamento"] .
...
Consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/failover.html["Falha na execução de aplicativos para um site remoto"] .
...
Para mais detalhes, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/manage.html["Gerenciar sites, grupos de recursos, planos de replicação, armazenamentos de dados e informações de máquinas virtuais"] .
...
Para mais detalhes, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/manage.html["Gerenciar planos de replicação"] .
...
. Observe o valor da contagem de retenção no plano de replicação.  Você precisará restabelecer esse valor original quando terminar essas etapas.
...
Consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/manage.html["Gerenciar planos"] .
...
Consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/manage.html["Gerenciar VMs"] .
...
Consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-prerequisites.html["Pré-requisitos do NetApp Disaster Recovery"] .
...
https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-intro.html["Saiba mais sobre a recuperação de desastres da NetApp"] .
...
Com o NetApp Disaster Recovery, você pode se inscrever para um teste gratuito de 90 dias ou Traga sua própria licença (BYOL), que é um arquivo de licença NetApp (NLF) que você obtém do seu representante de vendas da NetApp .  Você pode usar o número de série da licença para ativar o BYOL nas assinaturas do NetApp Console.  As cobranças do NetApp Disaster Recovery são baseadas na capacidade provisionada dos datastores.

Para obter detalhes sobre a configuração do licenciamento para o NetApp Disaster Recovery, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-licensing.html["Configurar licenciamento"] .

Para obter detalhes sobre o gerenciamento de licenças para *todos* os serviços de dados do NetApp Console, consulte https://docs.netapp.com/us-en/bluexp-digital-wallet/task-manage-data-services-licenses.html["Gerenciar licenças para todos os serviços de dados do NetApp Console"^] .
...
Para mais detalhes, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/drplan-create.html["Crie o plano de replicação"] .
...
Para mais detalhes, consulte https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/failover.html["Failover para um site remoto"] .
...
Agora você pode clicar nas opções do Painel, o que facilita a revisão rápida das informações. Além disso, o Painel agora mostra o status de failovers e migrações.
...
A página Job Monitor agora inclui uma opção Atualizar para que você possa obter um status atualizado das operações. Consulte  https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/monitor-jobs.html["Monitorar trabalhos de recuperação de desastres"] .
...
link:https://docs.netapp.com/us-en/bluexp-disaster-recovery/get-started/dr-intro.html["Saiba mais sobre a recuperação de desastres da NetApp"] .
