...
*Função de console NetApp necessária* A função de Super admin, Disaster recovery admin ou Disaster recovery application admin é necessária para executar esta tarefa.
...
*Função de console NetApp necessária* Superadministrador, administrador de recuperação de desastres, administrador de failover de recuperação de desastres ou administrador de aplicativos de recuperação de desastres.
...
*Função de console NetApp necessária* A função de Super admin, Disaster recovery admin, Disaster recovery failover admin ou Disaster recovery application admin é necessária para executar esta tarefa.
...
*Função de NetApp Console necessária* Superadministrador, administrador de recuperação de desastres, administrador de failover de recuperação de desastres, administrador de aplicativos de recuperação de desastres ou visualizador de recuperação de desastres.
