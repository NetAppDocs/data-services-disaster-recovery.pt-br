...
Durante um teste de failover, o Disaster Recovery cria máquinas virtuais temporárias. O Disaster Recovery mapeia um datastore temporário que faz backup do volume FlexClone para os hosts ESXi.
