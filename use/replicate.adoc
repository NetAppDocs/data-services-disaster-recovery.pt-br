...
summary: Usando o NetApp Disaster Recovery, você pode replicar aplicativos VMware no seu site de origem para um site remoto de recuperação de desastres na nuvem usando a replicação do SnapMirror . 
---
...
[role="lead"]
Usando o NetApp Disaster Recovery, você pode replicar aplicativos VMware no seu site de origem para um site remoto de recuperação de desastres na nuvem usando a replicação do SnapMirror .
