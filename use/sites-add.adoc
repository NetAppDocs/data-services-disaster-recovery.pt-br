...
+
Você será direcionado para a página do Painel de NetApp Disaster Recovery .  Ao iniciar o serviço pela primeira vez, você precisa adicionar informações do vCenter.  Mais tarde, o Painel exibe dados sobre seus sites e planos de replicação.
