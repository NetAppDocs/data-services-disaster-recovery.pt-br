...
+
Se esta for a sua primeira vez usando NetApp Disaster recovery, você precisa adicionar informações do vCenter. Se você já adicionou informações do vCenter, verá o painel.
...
TIP: Para adicionar mais sites do vCenter, selecione *Sites* e depois *Adicionar*.
