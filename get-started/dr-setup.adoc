...
[role="lead"]
Para usar NetApp Disaster Recovery, execute algumas etapas para configurá-lo tanto no NetApp Console quanto no ambiente de recuperação de desastres compatível.
