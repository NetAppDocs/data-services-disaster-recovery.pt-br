...
[role="lead"]
Antes de configurar o NetApp Disaster Recovery para Kubernetes, prepare cada cluster Kubernetes. A proteção normalmente se aplica a um cluster de origem e a um cluster de destino, então conclua esses procedimentos em cada cluster do par.
